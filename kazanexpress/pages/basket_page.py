...
class BasketPage(BasePage):
    ...
    def should_have_correct_price(self, price):
        ...
        assert str(price) == str(product_price_in_basket), "Incorrect product price in basket!"
